    ...
    1: [
        function (a, b, c) {
            !function (a, c) {
                ...
                function d(a) {
                    function b(a) {
                        for (var b = p.byteLength, c = r + a; b < c;) 
                            b *= 2;
                        if (b !== p.byteLength) {
                            var d = q;
                            p = new ArrayBuffer(b),
                    ...
                    function n(a) {
                        ...
                        switch (typeof a) {
                                ...
                                for (b = 0; b < a.length; ++b) {
                                    ...
                                    g < 128
                                        ...
                                        : g < 2048
                                            ...
                                            : g < 55296
                                                ? (d.push(224 | g >> 12), d.push(128 | g >> 6 & 63), d.push(128 | 63 & g))
                                                : (
                                                    g = (1023 & g) << 10,
                            ...
                            default:
                                var j;
                                if (Array.isArray(a)) 
                                    for (j = a.length, m(4, j), b = 0; b < j; ++b) 
                                        n(a[b]);
                    ...
                    if (n(a), "slice" in p) 
                        return p.slice(0, r);
                    for (var s = new ArrayBuffer(r), t = new DataView(s), u = 0; u < r; ++u) 
                ...
                function e(a, b, d) {
                    ...
                    function i() {
                        ...
                        if (31744 === e) 
                            ...
                            return g * f;
                        return b.setUint32(0, d << 16 | e << 13 | g << 13),
                        b.getFloat32(0)
                    }
                    function j() {
                        ...
                        for (var c = 0; c < b; ++c) {
                            ...
                            128 & d && (
                                d < 224
                                    ? (d = (31 & d) << 6 | 63 & l(), b -= 1)
                                    : d < 240
                                        ? (d = (15 & d) << 12 | (63 & l()) << 6 | 63 & l(), b -= 2)
                                        : (d = (15 & d) << 18 | (63 & l()) << 12 | (63 & l()) << 6 | 63 & l(), b -= 3)
                            ),
                            d < 65536
                                ? a.push(d)
                                : (d -= 65536, a.push(55296 | d >> 10), a.push(56320 | 1023 & d))
                        }
                    }
                    function t() {
                        var a,
        ...
        function (a, b, c) {
            (function (a) {
                !function (d) {
                    function e() {
                        this._events = {},
                        this._conf && f.call(this, this._conf)
                    }
                    function f(a) {
                        a
                            ? (
                                ...
                                this._maxListeners = a.maxListeners !== d
                                    ? a.maxListeners
                                    : l,
                    ...
                    function g(b, c) {
                        var d = "(node) warning: possible EventEmitter memory leak detected. " + b + " " +
                    ...
                    function i(a, b, c, d) {
                        ...
                        if ("*" === o || "**" === o || c[o]) {
                            if ("*" === o) {
                                for (g in c) 
                                    "_listeners" !== g && c.hasOwnProperty(g) && (
                            ...
                            if ("**" === o) {
                                ...
                                for (g in c) 
                                    "_listeners" !== g && c.hasOwnProperty(g) && (
                                        "*" === g || "**" === g
                                            ? (
                                                c[g]._listeners && !l && (m = m.concat(i(a, b, c[g], n))),
                        ...
                        if (h = c["*"], h && i(a, b, h, d + 1), j = c["**"]) 
                            if (d < n) {
                                ...
                                for (g in j) 
                                    "_listeners" !== g && j.hasOwnProperty(g) && (
                                        g === p
                                            ? i(a, b, j[g], d + 2)
                                            : g === o
                                                ? i(a, b, j[g], d + 1)
                    ...
                    for (var f = this.listenerTree, h = a.shift(); h !== d;) {
                            if (f[h] || (f[h] = {}), f = f[h], 0 === a.length) 
                                return f._listeners
                                    ? (
                                        "function" == typeof f._listeners && (f._listeners = [f._listeners]),
                                        f._listeners.push(b),
                                        !f._listeners.warned && this._maxListeners > 0 && f._listeners.length > this._maxListeners && (f._listeners.warned = !0, g.call(this, f._listeners.length, h))
                                    )
                                    : f._listeners = b,
                                !0;
                            h = a.shift()
                    ...
                    h.prototype._on = function (a, b, c) {
                        if ("function" == typeof a) 
                            return this._onAny(a, b),
                            this;
                        if ("function" != typeof b) 
                            throw new Error("on only accepts instances of Function");
                        return this._events || e.call(this),
                        ...
                        this.wildcard
                            ...
                            : (
                                this._events[a]
                                    ? (
                                        "function" == typeof this._events[a] && (this._events[a] = [this._events[a]]),
                                        c
                                            ? this._events[a].unshift(b)
                                            : this._events[a].push(b),
                                        !this._events[a].warned && this._maxListeners > 0 && this._events[a].length > this._maxListeners && (
                    ...
                    h.prototype.off = function (a, b) {
                        function c(a) {
                            if (a !== d) {
                                ...
                                for (var e in b) {
                                    var f = b[e],
                                        g = a[f];
                                    g instanceof Function || "object" != typeof g || null === g || (
                        ...
                        for (var h = 0; h < f.length; h++) {
                            ...
                            (e === b || e.listener && e.listener === b || e._origin && e._origin === b) && (
                                this.wildcard
                                    ? delete j._listeners
                                    : delete this._events[a],
                                this.emit("removeListener", a, b)
                        ...
                        if (this.wildcard) {
                            var b = [],
                                c = "string" == typeof a
                                    ? a.split(this.delimiter)
                                    : a.slice();
                            return i.call(this, b, c, this.listenerTree, 0),
                            b
                        }
                        return this._events || e.call(this),
    ...
    4: [
        function (a, b, c) {
            ...
            !function () {
                ...
                try {
                    m = "function" == typeof clearTimeout
                        ? clearTimeout
                        : e
                } catch (a) {
                    m = e
                    ...
                    0 === a.stamp.secs && 0 === a.stamp.secs && "" === a.id
                        ...
                        : (
                            b.currentGoal && a.id === b.currentGoal.goal_id.id
                                ? b.emit("cancel")
                                : b.nextGoal && a.id === b.nextGoal.goal_id.id && (b.nextGoal = null),
    ...
    13: [
        function (a, b, c) {
            ...
            d.prototype.get = function (a) {
                var b = new e(
                        {ros: this.ros, name: "/rosapi/get_param", serviceType: "rosapi/GetParam"}
                    ),
            ...
            d.prototype.set = function (a, b) {
                var c = new e(
                        {ros: this.ros, name: "/rosapi/set_param", serviceType: "rosapi/SetParam"}
                    ),
        ...
        function (a, b, c) {
            ...
            d.prototype.connect = function (a) {
                if ("socket.io" === this.transportLibrary) 
                    ...
                    this
                        .socket
                        .on("connect", this.socket.onopen),
                    this
                        .socket
                        .on("data", this.socket.onmessage),
                    this
                        .socket
                        .on("close", this.socket.onclose),
                    this
                        .socket
                        .on("error", this.socket.onerror);
                else if ("RTCPeerConnection" === this.transportLibrary.constructor.name) 
                    this.socket = i(
                        this.transportLibrary.createDataChannel(a, this.transportOptions),
                        f(this)
                    );
                else if (!this.socket || this.socket.readyState === e.CLOSED) {
                    var b = new e(a);
                    b.binaryType = "arraybuffer",
                    this.socket = i(b, f(this))
                }
            },
            ...
            d.prototype.callOnConnection = function (a) {
                var b = this,
                    c = JSON.stringify(a),
                    d = null;
                d = "socket.io" === this.transportLibrary
                    ? function (a) {
                        b
                            .socket
                            .emit("operation", a)
            ...
            d.prototype.getActionServers = function (a, b) {
                var c = new g(
                        {ros: this, name: "/rosapi/action_servers", serviceType: "rosapi/GetActionServers"}
                    ),
                    d = new h({});
                "function" == typeof b
            ...
            d.prototype.getTopics = function (a, b) {
                var c = new g(
                        {ros: this, name: "/rosapi/topics", serviceType: "rosapi/Topics"}
                    ),
                    d = new h;
                "function" == typeof b
                    ? c.callService(d, function (b) {
            ...
            d.prototype.getTopicsForType = function (a, b, c) {
                var d = new g(
                        {ros: this, name: "/rosapi/topics_for_type", serviceType: "rosapi/TopicsForType"}
                    ),
                    e = new h({type: a});
                "function" == typeof c
            ...
            d.prototype.getServices = function (a, b) {
                var c = new g(
                        {ros: this, name: "/rosapi/services", serviceType: "rosapi/Services"}
                    ),
                    d = new h;
                "function" == typeof b
                    ? c.callService(d, function (b) {
            ...
            d.prototype.getServicesForType = function (a, b, c) {
                var d = new g(
                        {ros: this, name: "/rosapi/services_for_type", serviceType: "rosapi/ServicesForType"}
                    ),
                    e = new h({type: a});
                "function" == typeof c
                    ? d.callService(e, function (a) {
            ...
            d.prototype.getServiceRequestDetails = function (a, b, c) {
                var d = new g(
                        {ros: this, name: "/rosapi/service_request_details", serviceType: "rosapi/ServiceRequestDetails"}
                    ),
                    e = new h({type: a});
                "function" == typeof c
                    ? d.callService(e, function (a) {
            ...
            d.prototype.getServiceResponseDetails = function (a, b, c) {
                var d = new g(
                        {ros: this, name: "/rosapi/service_response_details", serviceType: "rosapi/ServiceResponseDetails"}
                    ),
                    e = new h({type: a});
                "function" == typeof c
                    ? d.callService(e, function (a) {
            ...
            d.prototype.getNodes = function (a, b) {
                var c = new g({ros: this, name: "/rosapi/nodes", serviceType: "rosapi/Nodes"}),
                    d = new h;
                "function" == typeof b
                    ? c.callService(d, function (b) {
                        a(b.nodes)
            ...
            d.prototype.getNodeDetails = function (a, b, c) {
                var d = new g(
                        {ros: this, name: "/rosapi/node_details", serviceType: "rosapi/NodeDetails"}
                    ),
                    e = new h({node: a});
                "function" == typeof c
                    ? d.callService(e, function (a) {
            ...
            d.prototype.getParams = function (a, b) {
                var c = new g(
                        {ros: this, name: "/rosapi/get_param_names", serviceType: "rosapi/GetParamNames"}
                    ),
                    d = new h;
                "function" == typeof b
                    ? c.callService(d, function (b) {
            ...
            d.prototype.getTopicType = function (a, b, c) {
                var d = new g(
                        {ros: this, name: "/rosapi/topic_type", serviceType: "rosapi/TopicType"}
                    ),
                    e = new h({topic: a});
                "function" == typeof c
                    ? d.callService(e, function (a) {
            ...
            d.prototype.getServiceType = function (a, b, c) {
                var d = new g(
                        {ros: this, name: "/rosapi/service_type", serviceType: "rosapi/ServiceType"}
                    ),
                    e = new h({service: a});
                "function" == typeof c
                    ? d.callService(e, function (a) {
            ...
            d.prototype.getMessageDetails = function (a, b, c) {
                var d = new g(
                        {ros: this, name: "/rosapi/message_details", serviceType: "rosapi/MessageDetails"}
                    ),
                    e = new h({type: a});
                "function" == typeof c
                    ? d.callService(e, function (a) {
    ...
    15: [
        function (a, b, c) {
            ...
            d.prototype.advertise = function (a) {
                this.isAdvertised || "function" != typeof a || (
                    this._serviceCallback = a,
                    this.ros.on(this.name, this._serviceResponse.bind(this)),
                    this.ros.callOnConnection({op: "advertise_service", type: this.serviceType, service: this.name}),
                    this.isAdvertised = !0
                )
            },
    ...
    18: [
        function (a, b, c) {
            ...
            var e = a("../util/decompressPng"),
                ...
                h = (a("ws"), null);
            "undefined" != typeof bson && (h = bson().BSON),
            b.exports = d
        }, {
    ...
    19: [
        function (a, b, c) {
            function d(a) {
                ...
                this.compression && "png" !== this.compression && "cbor" !== this.compression && "none" !== this.compression && (
                    this.emit(
                        "warning",
                        this.compression +
            ...
            d.prototype.unsubscribe = function (a) {
                a && (this.off("message", a), this.listeners("message").length) || this.subscribeId && (
                    this.ros.off(this.name, this._messageCallback),
                    this.reconnect_on_close && this.ros.off("close", this.reconnectFunc),
                    this.emit("unsubscribe"),
                    this.ros.callOnConnection({op: "unsubscribe", id: this.subscribeId, topic: this.name}),
            ...
            d.prototype.unadvertise = function () {
                this.isAdvertised && (
                    ...
                    this.ros.callOnConnection({op: "unadvertise", id: this.advertiseId, topic: this.name}),
                    this.isAdvertised = !1
                )
            },
        ...
        function (a, b, c) {
            ...
            d.prototype.multiply = function (a) {
                ...
                return b.applyTransform(
                    {rotation: this.orientation, translation: this.position}
                ),
                b
            },
            d.prototype.getInverse = function () {
                ...
                a
                    .position
                    .multiplyQuaternion(a.orientation),
                a.position.x *= -1,
                a.position.y *= -1,
                a.position.z *= -1,
                a
    ...
    27: [
        function (a, b, c) {
            function d(a) {
                ...
                this.serviceClient = this
                    .ros
                    .Service(
                        {name: this.repubServiceName, serviceType: "tf2_web_republisher/RepublishTFs"}
                    )
            }
            ...
            d.prototype.processTFArray = function (a) {
                a
                    ...
                    .forEach(function (a) {
                        ...
                        c && (
                            c.transform = new g({translation: a.transform.translation, rotation: a.transform.rotation}),
            ...
            d.prototype.updateGoal = function () {
                ...
                if (this.ros.groovyCompatibility) 
                    this.currentGoal && this
                        .currentGoal
                        .cancel(),
                    this.currentGoal = new e({actionClient: this.actionClient, goalMessage: a}),
                    this
                        .currentGoal
                        .on("feedback", this.processTFArray.bind(this)),
                    this
                        .currentGoal
                        .send();
                else {
                    ...
                    this
                        .serviceClient
                        .callService(b, this.processResponse.bind(this))
                }
                this.republisherUpdateRequested = !1
            },
            d.prototype.processResponse = function (a) {
                this.currentTopic && this
                    .currentTopic
                    .unsubscribe(),
                this.currentTopic = this
                    .ros
                    .Topic({name: a.topic_name, messageType: "tf2_web_republisher/TFArray"}),
                this
                    .currentTopic
                    .subscribe(this.processTFArray.bind(this))
            },
            d.prototype.subscribe = function (a, b) {
                ...
                this.frameInfos[a]
                    ? this
                        .frameInfos[a]
                        .transform && b(this.frameInfos[a].transform)
                    : (this.frameInfos[a] = {
                        cbs: []
                ...
                if (0 === h.length) 
                    ...
                    if (k) {
                        ...
                        var m = parseFloat(k[0]),
                            ...
                            q = n / 2,
                            r = o / 2,
                            s = Math.sin(p) * Math.cos(q) * Math.cos(r) - Math.cos(p) * Math.sin(q) * Math.sin(
                                r
                            ),
                            t = Math.cos(p) * Math.sin(q) * Math.cos(r) + Math.sin(p) * Math.cos(q) * Math.sin(
                                r
                            ),
                            u = Math.cos(p) * Math.cos(q) * Math.sin(r) - Math.sin(p) * Math.sin(q) * Math.cos(
                                r
                            ),
                            v = Math.cos(p) * Math.cos(q) * Math.cos(r) + Math.sin(p) * Math.sin(q) * Math.sin(
                                r
                            );
                        l = new g({x: s, y: t, z: u, w: v}),
                        l.normalize()
                    }
                ...
                if (0 === c.length) 
                    ...
                    if (n) {
                        ...
                        var p = parseFloat(n[0]),
                            ...
                            t = q / 2,
                            u = r / 2,
                            v = Math.sin(s) * Math.cos(t) * Math.cos(u) - Math.cos(s) * Math.sin(t) * Math.sin(
                                u
                            ),
                            w = Math.cos(s) * Math.sin(t) * Math.cos(u) + Math.sin(s) * Math.cos(t) * Math.sin(
                                u
                            ),
                            x = Math.cos(s) * Math.cos(t) * Math.sin(u) - Math.sin(s) * Math.sin(t) * Math.cos(
                                u
                            ),
                            y = Math.cos(s) * Math.cos(t) * Math.cos(u) + Math.sin(s) * Math.sin(t) * Math.sin(
                                u
                            );
                        o = new g({x: v, y: w, z: x, w: y}),
                        o.normalize()
                    }
